...
USER_AGENT = "nyc-review-p13.5/1.0 (https://github.com/hollis-yang/nyc-review; educational portfolio)"
...
def typescript_manifest(
    *,
    ...
    return (
        "// Generated by nyc-review-web/scripts/p13_5_visual_assets.py. Do not edit by hand.\n"
...
def main() -> None:
    ...
    credits = {
        "metadata": {
            "datasetId": "nyc-review-p13.5-frontend-contextual-visuals",
