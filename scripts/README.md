...
| `nyc_data_pipeline/` | Enrich real merchant identities from free public sources and resolve fields/images | Required when refreshing or improving the real dataset |
...
python3 -m unittest scripts.nyc_data_pipeline.test_pipeline
