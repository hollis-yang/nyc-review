#!/usr/bin/env python3
"""Aggregate accepted P14.1 evidence without exposing runtime credentials."""
...
def load_json(path: Path) -> dict:
    if not path.is_file():
        raise FileNotFoundError(f"Required P14.1 evidence is missing: {path}")
