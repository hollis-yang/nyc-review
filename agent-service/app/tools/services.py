...
class GeneratedNycShopToolService:
    ...
    def _to_candidate(
        ...
        return ShopCandidate(
            ...
            external_id=shop.get("externalId"),
            source_name=shop.get("sourceName"),
            source_url=shop.get("sourceUrl"),
            source_fetched_at=shop.get("sourceFetchedAt"),
...
class HttpShopToolService:
    ...
    def _to_candidate(item: dict) -> ShopCandidate:
        return ShopCandidate(
            ...
            local_review_count=item.get("localReviewCount", item.get("comments")),
            local_score=item.get("localScore"),
            rating_count=item.get("ratingCount"),
            external_rating_count=item.get("externalRatingCount", item.get("ratingCount")),
            external_score=item.get("externalScore"),
                ...
                ShopEvidence(
                    ...
                    citations=[
                        EvidenceCitation(
                            ...
                            source_name="NYC Review in-memory test fixture",
                            synthetic=True,
