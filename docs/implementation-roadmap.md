...
P10/P11/P11.5/P12 已完成；后续从 P13 的 10,000+ 真实商户增量扩容开始。每个阶段都先在隔离数据上通过门禁，再允许一次开发环境 checkpoint 切换以展示结果；P16 是最终发布候选的一致性审计和回滚演练。正式范围、量化验收条件和不可回退约束见 [P10–P17 Delivery Roadmap](p10-p17-roadmap.md)。
