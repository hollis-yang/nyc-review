...
public class RabbitMqConfig {
    ...
    public static final String ORDER_EXCHANGE = "nyc-review.voucher.order.exchange";
    public static final String ORDER_QUEUE = "nyc-review.voucher.order.queue";
    public static final String ORDER_ROUTING_KEY = "voucher.order.accepted";
    public static final String ERROR_EXCHANGE = "nyc-review.voucher.order.error.exchange";
    public static final String ERROR_QUEUE = "nyc-review.voucher.order.error.queue";
