...
CREATE TABLE IF NOT EXISTS `tb_shop_image` (
    ...
    `display_url` VARCHAR(1024) NOT NULL COMMENT 'URL rendered by HMDP; not a claimed shop photograph',
...
PREPARE HMDP_P8_STMT FROM @HMDP_P8_SQL;
EXECUTE HMDP_P8_STMT;
DEALLOCATE PREPARE HMDP_P8_STMT;
